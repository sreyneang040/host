...
$routes->get('updateProfile','UserController::updateProfile',['filter'=>'checkUsers']);
...
$routes->add('createYourEvent','YourEventController::createEvent');
$routes->add('updateYourEvent','YourEventController::updateYourEvent');
$routes->get('category','AdminController::showCategory',['filter'=>'checkUsers']);
$routes->match(['get','post'],'updateCategory','AdminController::update');
